      ...
      <ul className="nav nav-pills nav-flush flex-column text-center nav-underline fs-4">
        ...
        <li className="nav-item">
          <OverlayTrigger
            placement="right"
            delay={{ show: 250, hide: 400 }}
            overlay={<Tooltip id="drinks-tooltip">{"Drinks"}</Tooltip>}
          >
            <NavLink className="nav-link py-3" aria-current="page" to="/drinks">
              {({ isActive }) => (
                <svg
                  width="30"
                  height="30"
                  ...
                  className={
                    "image-svg-svg primary boba-svg-nav" + svgFill(isActive)
                  }
                >
        ...
        <li className="nav-item">
          ...
          >
            <NavLink className="nav-link py-3" aria-current="page" to="/orders">
        ...
        <li className="nav-item">
          ...
          >
            ...
            >
              {({ isActive }) => (
                <i className={"bi bi-person" + fill(isActive)} />
              )}
            </NavLink>
          </OverlayTrigger>
        </li>
